...
async def upload_job_descriptions(request: JobUploadRequest, user_id: str = Depends(get_user_id)) -> JobUploadResponse:
...
@router.get("/{job_id}")
async def get_job(job_id: str, user_id: str = Depends(get_user_id)) -> dict:
