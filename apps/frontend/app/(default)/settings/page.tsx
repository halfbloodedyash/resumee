...
const SEGMENTED_BUTTON_BASE =
  'border border-border transition-all duration-150 ease-out shadow-sm hover:translate-y-[1px] hover:translate-x-[1px] hover:shadow-none disabled:cursor-not-allowed disabled:opacity-50';
const SEGMENTED_BUTTON_ACTIVE = 'bg-primary text-white border-border hover:bg-blue-800';
const SEGMENTED_BUTTON_INACTIVE = 'bg-card text-foreground hover:bg-accent';
...
export default function SettingsPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-start bg-muted/50 p-6 md:p-12 min-h-screen overflow-y-auto">
      <div className="w-full max-w-4xl border border-border bg-card shadow-sm">
        {/* Header */}
        <div className="border-b border-border p-8 bg-card flex justify-between items-start">
          <div>
        ...
        <div className="p-8 space-y-10">
          ...
          <section className="space-y-4">
            <div className="flex items-center justify-between border-b border-border/10 pb-2">
              <div className="flex items-center gap-3">
                <div className="flex items-center gap-2">
                  ...
                  <h2 className="text-sm font-bold">{t('settings.systemStatus.title')}</h2>
                </div>
                {lastFetched && (
            ...
            {statusLoading ? (
              ...
              <div className="flex flex-col items-center justify-center p-8 gap-3 border border-dashed border-red-300 bg-red-50">
                <p className="text-xs text-red-600">{t('settings.systemStatus.unableToConnect')}</p>
          ...
          <section className="space-y-6">
            <div className="flex items-center gap-2 border-b border-border/10 pb-2">
              ...
              <h2 className="text-sm font-bold">{t('settings.contentGeneration.title')}</h2>
            </div>
        ...
        {/* Footer */}
        <div className="bg-accent p-4 border-t border-border flex justify-between items-center">
          <div className="flex items-center gap-2">
            <Image
              src="/logo.svg"
              alt="Resume Matcher"
