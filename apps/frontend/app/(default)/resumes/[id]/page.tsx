...
export default function ResumeViewerPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-card">
        ...
        <p className="text-sm font-bold text-primary">{t('resumeViewer.loading')}</p>
      </div>
    );
  }
  ...
  if (error || !resumeData) {
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-card p-4">
        <div
          className={`border p-6 text-center max-w-md shadow-sm ${
            isProcessing
  ...
  return (
    <div className="min-h-screen bg-card py-12 px-4 md:px-8 overflow-y-auto">
      <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-6 no-print">
            {isEditingTitle ? (
              <input
                ...
                className="text-2xl font-bold border-b-2 border-border bg-transparent outline-none w-full max-w-xl px-0 py-1"
              />
            ) : (
              <button
                onClick={() => {
              ...
              >
                <h2
                  className={`text-2xl font-bold border-b-2 border-transparent group-hover:border-border transition-colors ${!resumeTitle ? 'text-muted-foreground/60' : ''}`}
                >
        ...
        <div className="flex justify-center pb-4">
          <div className="resume-print w-full max-w-[250mm] shadow-sm border border-border bg-card">
            <Resume
