...
const ResumeBuilderContent = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-background flex justify-center items-center p-4 md:p-8">
      {/* Main Container */}
      <div className="w-full max-w-[90%] md:max-w-[95%] xl:max-w-[1800px] border border-border bg-card rounded-2xl shadow-lg flex flex-col min-h-[92vh]">
        {/* Header Section */}
        <div className="border-b border-border p-6 md:p-8 bg-card rounded-t-2xl no-print">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
            <div>
              ...
              <h1 className="text-3xl md:text-4xl text-foreground tracking-tight font-semibold">
                {t('nav.builder')}
              </h1>
              <div className="mt-3 flex items-center gap-3">
                ...
                {hasUnsavedChanges && (
                  <span className="flex items-center gap-1 text-xs text-amber-500 bg-amber-500/10 px-2 py-1 rounded-md border border-amber-500/20">
        ...
        {/* Content Grid */}
        <div className="grid min-h-0 flex-1 grid-cols-1 gap-4 bg-background p-4 lg:grid-cols-2">
          {/* Left Panel: Editor */}
          <div className="bg-card rounded-xl p-6 md:p-8 overflow-y-auto no-print">
          ...
          <div className="bg-muted/30 overflow-hidden flex flex-col rounded-xl no-print">
            {/* Tabs Header */}
            <div className="px-6 pt-3 shrink-0 bg-muted/30">
              <RetroTabs
                tabs={[
        ...
        {/* Footer */}
        <div className="p-4 bg-card flex justify-between items-center text-xs text-muted-foreground border-t border-border rounded-b-2xl no-print">
