  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px] p-0 gap-0 rounded-lg">
        ...
        <DialogFooter className="p-4 bg-card border-t border-border flex-row justify-end gap-3">
          <DialogClose asChild>
  ...
  return (
    <>
      <Button
        ...
        className="w-full rounded-lg border-dashed border border-border py-6 hover:bg-muted/50 hover:border-solid transition-all"
      >
