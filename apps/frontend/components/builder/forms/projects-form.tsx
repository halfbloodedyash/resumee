  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-8">
        {data.map((item) => (
          <div key={item.id} className="p-6 border border-border bg-muted/50 relative group">
            <Button
              variant="ghost"
              size="icon"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4 pr-8">
              ...
              <div className="space-y-2">
                <Label className="text-xs text-muted-foreground">
                  ...
                  GitHub <span className="text-muted-foreground/60">({t('common.optional')})</span>
                </Label>
                <Input
                  value={item.github || ''}
        ...
        {data.length === 0 && (
          <div className="text-center py-12 bg-muted/50 border border-dashed border-border">
