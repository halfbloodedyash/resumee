...
export const GenericListForm: React.FC<GenericListFormProps> = ({
  ...
  return (
    <div className="space-y-2">
      <Label className="text-xs text-muted-foreground">{finalLabel}</Label>
      <p className="text-xs text-primary border-l-2 border-primary pl-3 mb-2">
      ...
      <Textarea
        ...
        className="min-h-[150px] text-foreground rounded-lg border-border bg-card focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:border-primary"
      />
    </div>
  );
};
