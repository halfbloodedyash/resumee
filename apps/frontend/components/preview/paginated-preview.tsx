...
export function PaginatedPreview({ resumeData, settings }: PaginatedPreviewProps) {
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      {/* Controls bar */}
      <div className="flex items-center justify-between px-4 py-2 border-b border-border bg-accent shrink-0">
      ...
      <div ref={containerRef} className="flex-1 overflow-auto bg-accent p-6">
