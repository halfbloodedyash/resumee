  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        {trigger || (
          <Button className="rounded-lg border border-border shadow-sm hover:translate-y-[1px] hover:translate-x-[1px] hover:shadow-none transition-all">
            <UploadIcon className="w-4 h-4 mr-2" />
            {t('dashboard.uploadResume')}
          </Button>
        )}
      </DialogTrigger>
      <DialogContent className="sm:max-w-md bg-card border border-border shadow-sm p-0 gap-0 rounded-lg">
        ...
        <div className="p-6 bg-card">
          <div
            className={`
                            ...
                            ${isDragging ? 'border-primary bg-primary/10' : 'border-border hover:border-border hover:bg-card'}
          ...
          >
            ...
            {isUploadingGlobal ? (
              <div className="flex flex-col items-center py-4">
                ...
                <p className="text-sm font-bold text-primary">{t('common.uploading')}</p>
              </div>
            ) : currentFile ? (
              <div className="flex items-center justify-between gap-4">
                <div className="flex items-center gap-3 text-left overflow-hidden">
                  <div className="w-10 h-10 border border-border bg-accent flex items-center justify-center shrink-0">
              ...
              <div className="flex flex-col items-center py-4">
                <div className="w-12 h-12 border border-border bg-card shadow-sm flex items-center justify-center mb-4">
                  <UploadIcon className="w-6 h-6 text-foreground" />
                </div>
        ...
        <div className="p-4 border-t border-border bg-card flex justify-end gap-2">
          ...
          <DialogClose asChild>
            <Button variant="outline" className="rounded-lg border-border hover:bg-accent">
              {t('common.cancel')}
            </Button>
          </DialogClose>
        </div>
