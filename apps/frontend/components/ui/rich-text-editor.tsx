...
export const RichTextEditor: React.FC<RichTextEditorProps> = ({
  ...
  // SSR-safe mount detection without useState+useEffect
  ...
  if (!isMounted) {
    return (
      <div className={cn('space-y-1', className)}>
        <div className="flex items-center gap-1 p-1 border border-border bg-muted/50 rounded-t-lg h-9" />
        <div
          className={cn(
            'w-full border border-border bg-input',
