  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="mb-6">
        ...
        <p className="text-muted-foreground text-sm">{t('enrichment.preview.description')}</p>
      </div>
  ...
  return (
    <div className="border border-border bg-card shadow-sm">
      ...
      <div className="flex items-center gap-2 px-4 py-3 border-b border-border bg-muted/50">
        ...
        <span className="text-sm font-bold">{itemTypeLabel}</span>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {enhancement.enhanced_description.map((bullet, i) => (
                <li
                  key={i}
                  className="text-sm text-foreground pl-4 border-l-2 border-green-500 bg-green-50 py-1 pr-2"
                >
                  {bullet}
                </li>
              ))}
